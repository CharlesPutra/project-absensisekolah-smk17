...
<body>
    ...
    <form action="{{ route('guru.update', $guruedit->id) }}" method="POST">
        @csrf
        @method('PUT')
        <label for="no_guru" class="form-label">Id Karyawan/Guru</label>
        <input type="int" id="no_guru" name="no_guru" class="form-control" value="{{ $guruedit->no_guru }}">
        <label for="nama_guru" class="form-label">Nama Karyawan/Guru</label>
        <input type="text" id="nama_guru" name="nama_guru" class="form-control" value="{{ $guruedit->nama_guru }}">

        {{-- select jenis kelamin  --}}
        <label for="jenis_kelamin" class="form-label">Jenis Kelamin</label>
        <select id="jenis_kelamin" name="jenis_kelamin" class="form-select">
            <option selected value="{{ $guruedit->jenis_kelamin }}">{{ $guruedit->jenis_kelamin }}</option>
        ...
        <select id="karyawan" name="karyawan" class="form-select" required>
            <option selected value="{{ $guruedit->karyawan }}">{{ $guruedit->karyawan }}</option>
            <option value="Karyawan">Karyawan</option>
            <option value="Guru">Guru</option>
        </select>
        <div id="passwordHelpBlock" class="form-text">
            saran ketika role yang muncul guru tolong click role guru yang paling bawah lagi ketika mau merubah jadwal guru dan jurusan guru 
        </div>
        {{-- Select Role End --}}
        ...
        <div id="karyawanFields">
            ...
            <select id="id_jadwalkaryawan" name="id_jadwalkaryawan" class="form-select">
                <option selected value="{{ $guruedit->id_jadwalkaryawan }}">{{ optional($guruedit->jadwalkr)->no_jadwal }}</option>
        ...
        <div class="additional-fields" id="guruFields" style="display: none;">
            ...
            <select id="id_jurusan" name="id_jurusan" class="form-select">
                <option selected value="{{ $guruedit->id_jurusan }}">{{ optional($guruedit->jurusan)->no_jurusan }}</option>
            ...
            <select id="id_jadwalguru" name="id_jadwalguru" class="form-select">
                <option selected value="{{ $guruedit->id_jadwalguru }}">{{ optional($guruedit->jadwalgr)->no_jadwalguru}}</option>
