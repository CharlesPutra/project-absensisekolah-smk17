...
<head>
    ...
    <title>Ubah Data Jadwal Karyawan</title>
...
<body>
    ...
    {{-- halaman home --}}
    <h2>Ubah Data Jadwal Karyawan</h2>
    <form action="{{ route('jadwalkaryawan.update',$karyawanedit->id) }}" method="POST">
        @csrf
        @method('PUT')
        <label for="no_jadwal" class="form-label">Kode Jadwal</label>
        <input type="text" id="no_jadwal" name="no_jadwal" class="form-control" value="{{ $karyawanedit->no_jadwal }}">
        <label for="hari" class="form-label">Hari</label>
        <input type="text" id="hari" name="hari" class="form-control" value="{{ $karyawanedit->hari }}">
        <label for="masuk" class="form-label">Jam Masuk</label>
        <input type="text" id="masuk" name="masuk" class="form-control" placeholder="CONTOH : PUKUL 06.30" value="{{ $karyawanedit->masuk }}">
        <label for="pulang" class="form-label">Jam Pulang</label>
        <input type="text" id="pulang" name="pulang" class="form-control" placeholder="CONTOH : PUKUL 12.30" value="{{ $karyawanedit->pulang }}">
        <label for="keterlambatan" class="form-label">Keterlambatan</label>
        <input type="text" id="keterlambatan" name="keterlambatan" class="form-control" placeholder="CONTOH : 120MENIT" value="{{ $karyawanedit->keterlambatan }}">
        ...
        {{-- textarea --}}
        <label for="keterangan" class="form-label">Keterangan</label>
        <textarea id="keterangan" name="keterangan" class="form-control">{{ $karyawanedit->keterangan }}</textarea>
        {{-- textarea end --}}
