...
<head>
    ...
    <title>Tambah Data Jadwal Karyawan</title>
...
<body>
    ...
    {{-- halaman home --}}
    <h2>Tambah Data Jadwal Karyawan</h2>
    <form action="{{ route('jadwalkaryawan.store') }}" method="POST">
        @csrf
        <label for="no_jadwal" class="form-label">Kode Jadwal</label>
        <input type="text" id="no_jadwal" name="no_jadwal" class="form-control">
        <label for="hari" class="form-label">Hari</label>
        <input type="text" id="hari" name="hari" class="form-control">
        <label for="masuk" class="form-label">Jam Masuk</label>
        <input type="text" id="masuk" name="masuk" class="form-control" placeholder="CONTOH : PUKUL 06.30">
        <label for="pulang" class="form-label">Jam Pulang</label>
        <input type="text" id="pulang" name="pulang" class="form-control" placeholder="CONTOH : PUKUL 12.30">
        <label for="keterlambatan" class="form-label">Keterlambatan</label>
        <input type="text" id="keterlambatan" name="keterlambatan" class="form-control" placeholder="CONTOH : 120MENIT">
